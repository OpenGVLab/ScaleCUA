# Modified based on https://github.com/xlang-ai/OSWorld/blob/main/mm_agents/aguvis_agent.py
                        ...
                        "content": [
                            {
                                "type": "image_url",
                                "image_url": {
                                    "url": f"data:image/png;base64,{pil_to_base64(image_grounder)}",
                                    "detail": "high",
                                },
                            },
                            {
    ...
    def call_llm(self, payload, model):
        if model.startswith("gpt"):
            ...
            if "7b" in model or "7B" in model:
                ...
                # client = OpenAI(
                #     base_url="http://10.140.52.49:10004/v1",
                #     api_key="empty",
                # )
