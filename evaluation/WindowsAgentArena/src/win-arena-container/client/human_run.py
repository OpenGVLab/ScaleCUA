...
def human_agent():
    ...
    parser.add_argument(
        "-e", "--example", type=str, help="Path to the example json file."
    )
    ...
    example_path = (
        ...
        else "evaluation_examples_windows/examples/chrome/af630914-714e-4a24-a7bb-f9af687d3b91-wos.json"
    )
    ...
    logger.info(
        "\x1b[32m[TASK INSTRUCTION]: \x1b[32;3m%s\x1b[0m", example["instruction"]
    )
