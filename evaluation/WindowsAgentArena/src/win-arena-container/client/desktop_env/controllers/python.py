...
class PythonController:
    ...
    def update_computer(
        ...
        def image_to_base64_str(image):
            ...
            image.save(
                buffered, format="PNG"
            )  # you can change the format to your preferred format
        ...
        response = requests.post(
            self.http_server + "/update_computer", headers=headers, json=payload
        )
        if response.status_code == 200:
            logger.info("Updated computer successfully")
        else:
            logger.error(
                "Failed to update computer. Status code: %d", response.status_code
            )
    ...
    def get_screenshot(self):
        ...
        if response.status_code == 200:
            ...
            logger.error(
                "Failed to get screenshot. Status code: %d", response.status_code
            )
            return None
    ...
    def get_terminal_output(self):
        ...
        if response.status_code == 200:
            ...
            logger.error(
                "Failed to get terminal output. Status code: %d", response.status_code
            )
            return None
    ...
    def get_obs_winagent(self):
        ...
        if response.status_code == 200:
            ...
            logger.error(
                "Failed to get the observations for the agent from the server. Status code: %d",
    ...
    def get_accessibility_tree(self, backend: Optional[str] = None) -> Optional[str]:
        try:
            response: requests.Response = requests.get(
                self.http_server
                + (
                    f"/accessibility?backend={backend}" if backend else "/accessibility"
                ),
            ...
            if response.status_code == 200:
                ...
                logger.error(
                    "Failed to get accessibility tree. Status code: %d",
                    response.status_code,
                )
                return None
    ...
    def save_state(self, state: str):
        ...
        headers = {"Content-Type": "application/json"}
        response = requests.post(
            self.http_server + "/save_state", headers=headers, data=payload
        )
        if response.status_code == 200:
    ...
    def revert_to_snapshot(self, state: str):
        ...
        headers = {"Content-Type": "application/json"}
        response = requests.post(
            self.http_server + "/revert_to_snapshot", headers=headers, data=payload
        )
        if response.status_code == 200:
            logger.info("Reverted to snapshot successfully")
        else:
            logger.error(
                "Failed to revert to snapshot. Status code: %d", response.status_code
            )
    ...
    def execute_python_windows_command(self, command: str) -> None:
        ...
        try:
            response = requests.post(
                self.http_server + "/execute_windows",
                headers=headers,
                json=payload,
                timeout=90,
            )
            if response.status_code == 200:
                ...
                logger.error(
                    "Failed to execute command. Status code: %d", response.status_code
                )
    ...
    def execute_python_command(self, command: str) -> None:
        ...
        try:
            response = requests.post(
                self.http_server + "/execute", headers=headers, data=payload, timeout=90
            )
            if response.status_code == 200:
                logger.info("Command executed successfully: %s", response.text)
            else:
    ...
    def start_recording(self):
        ...
        if response.status_code == 200:
            ...
            logger.error(
                "Failed to start recording. Status code: %d", response.status_code
            )
    ...
    def end_recording(self, dest: str):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                logger.error(
                    "Failed to stop recording. Status code: %d", response.status_code
                )
                return None
        except Exception as e:
            logger.error(
                "An error occurred while trying to download the recording: %s", e
            )
    ...
    def get_vm_screen_size(self):
        ...
        if response.status_code == 200:
            ...
            logger.error(
                "Failed to get screen size. Status code: %d", response.status_code
            )
            return None
    ...
    def get_vm_window_size(self, app_class_name: str):
        ...
        """
        response = requests.post(
            self.http_server + "/window_size", data={"app_class_name": app_class_name}
        )
        if response.status_code == 200:
            return response.json()
        else:
            logger.error(
                "Failed to get window size. Status code: %d", response.status_code
            )
            return None
    ...
    def get_vm_wallpaper(self):
        ...
        if response.status_code == 200:
            ...
            logger.error(
                "Failed to get wallpaper. Status code: %d", response.status_code
            )
            return None
    ...
    def get_vm_desktop_path(self):
        ...
        if response.status_code == 200:
            ...
            logger.error(
                "Failed to get desktop path. Status code: %d", response.status_code
            )
            return None
    ...
    def get_vm_documents_path(self):
        ...
        if response.status_code == 200:
            ...
            logger.error(
                "Failed to get documents path. Status code: %d", response.status_code
            )
            return None
    ...
    def get_vm_folder_exists_in_path(self, folder_name, path):
        ...
        headers = {"Content-Type": "application/json"}
        response = requests.post(
            self.http_server + "/folder_exists", headers=headers, data=payload
        )
        if response.status_code == 200:
            ...
            logger.error(
                "Failed to get folder exists. Status code: %d", response.status_code
            )
            return False
    ...
    def get_vm_file_exists_in_path(self, file_name, path):
        ...
        headers = {"Content-Type": "application/json"}
        response = requests.post(
            self.http_server + "/file_exists", headers=headers, data=payload
        )
        if response.status_code == 200:
            ...
            logger.error(
                "Failed to get file exists. Status code: %d", response.status_code
            )
            return False
    ...
    def get_vm_are_files_sorted_by_modified_time(self, directory) -> bool:
        ...
        response = requests.post(
            self.http_server + "/are_files_sorted_by_modified_time",
            headers=headers,
            data=payload,
        )
        if response.status_code == 200:
            ...
            logger.error(
                "Files are not sorted by modified time. Status text: %s", response.text
            )
            return False
    ...
    def get_vm_is_directory_read_only_for_user(self, directory, user) -> bool:
        ...
        headers = {"Content-Type": "application/json"}
        response = requests.post(
            self.http_server + "/is_directory_read_only_for_user",
            headers=headers,
            data=payload,
        )
        if response.status_code == 200:
            ...
            logger.error(
                f"Directory {directory} is not read-only for user {user}. Status text: %s",
                response.text,
            )
            return False
    ...
    def get_vm_are_all_images_tagged(self, directory, tag) -> bool:
        ...
        headers = {"Content-Type": "application/json"}
        response = requests.post(
            self.http_server + "/are_all_images_tagged", headers=headers, data=payload
        )
        if response.status_code == 200:
            ...
            logger.error(
                f"Not all images in {directory} are tagged with {tag}. Status text: %s",
                response.text,
            )
            return False
    ...
    def get_vm_directory_tree(self, path):
        ...
        headers = {"Content-Type": "application/json"}
        response = requests.post(
            self.http_server + "/list_directory", headers=headers, data=payload
        )
        if response.status_code == 200:
            ...
            logger.error(
                "Failed to get directory tree. Status code: %d", response.status_code
            )
            return None
    ...
    def get_vm_file_explorer_is_details_view(self, path):
        ...
        headers = {"Content-Type": "application/json"}
        response = requests.post(
            self.http_server + "/is_details_view", headers=headers, data=payload
        )
        if response.status_code == 200:
            ...
            logger.error(
                "File explorer is not set to details view. Status code: %d",
                response.status_code,
            )
            return False
    ...
    def get_vm_library_folders(self, library_name):
        ...
        headers = {"Content-Type": "application/json"}
        response = requests.post(
            self.http_server + "/library_folders", headers=headers, data=payload
        )
        if response.status_code == 200:
            ...
            logger.error(
                "Failed to get library folders. Status text: %s", response.text
            )
            return None
    ...
    def get_vm_check_if_timer_started(self, hours, minutes, seconds):
        ...
        logger.info(
            f"Checking if timer exists: {hours} hours {minutes} minutes {seconds} seconds"
        )

        response = requests.post(
            self.http_server + "/check_if_timer_started", headers=headers, data=payload
        )
        if response.status_code == 200:
            ...
            logger.error(
                "Timer is not start or does not exist in Clock app. Status text: %s",
                response.text,
            )
            return "False"
    ...
    def get_vm_check_if_world_clock_exists(self, city, country):
        ...
        response = requests.post(
            self.http_server + "/check_if_world_clock_exists",
            headers=headers,
            data=payload,
        )
        if response.status_code == 200:
            ...
            logger.error(
                "World clock does not exist in Clock app. Status text: %s",
                response.text,
            )
            return "False"
    ...
    def execute_shell_command(self, command):
        ...
        try:
            response = requests.post(
                self.http_server + "/execute", headers=headers, json=payload, timeout=90
            )
            if response.status_code == 200:
                logger.info("Command executed successfully: %s", response.text)
                return response.json()
