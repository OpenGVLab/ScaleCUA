...
from android_world.task_evals.information_retrieval.proto import (
    state_pb2 as android__world_dot_task__evals_dot_information__retrieval_dot_proto_dot_state__pb2,
)
