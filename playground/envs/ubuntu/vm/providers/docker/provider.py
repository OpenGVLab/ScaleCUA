...
class DockerProvider(Provider):
    def __init__(self, region: str, image: str = "happysixd/osworld-docker", mount_mode: str = "ro"):
        ...
        self.lock_file = temp_dir / "docker_port_allocation.lck" # DEBUG: use this to avoid multi-user conflict
        ...
        def check_screenshot():
            try:
                ...
                response = requests.get(
                    f"http://0.0.0.0:{self.server_port}/screenshot",
                    timeout=(10, 10)
                )
    ...
    def start_emulator(self, path_to_vm: str, headless: bool, os_type: str):
        ...
        try:
            with lock:
                ...
                logger.info(f"trying to start container with ports - VNC: {self.vnc_port}, "
