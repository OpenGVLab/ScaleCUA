""" Script to set up ubuntu env.
Utils and basic architecture credit to https://github.com/xlang-ai/OSWorld/blob/main/desktop_env/controllers/setup.py """
import json
import logging
import os
import os.path
...
from envs.ubuntu.vm.utils import compare_urls

logger = logging.getLogger("vm.setup")
    ...
    def _googledrive_setup(self, **config):
        ...
        for oid, operation in enumerate(config['operation']):
            if operation == 'delete':  # delete a specific file
                ...
                # import pdb; pdb.set_trace() # Internet is needed
